...
using TestyAppyApp.Models;
using TestyAppyApp.Data;
using TestyAppyApp.Filter;
using TestyAppyApp.Entities;
using TestyAppyApp.Authorization;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.JsonPatch;
using System.Linq.Expressions;

namespace TestyAppyApp.Controllers
{
    /// <summary>
    ...
    {
        private readonly TestyAppyAppContext _context;

        public RoleEntitlementController(TestyAppyAppContext context)
        {
            _context = context;
        }
