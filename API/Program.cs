...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "TestyAppyApp", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<TestyAppyAppContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "TestyAppyApp API v1");
